...
do
	...
	mkdir results/affinity-5GB-hotsupplier/monitor-${i}
	cp *partition*.log results/affinity-5GB-hotsupplier/monitor-${i}/
	./scripts/save_results.sh results/affinity-5GB-hotsupplier/monitor-${i}
	sleep 5m
done
