...
do
        ...
        mkdir results/TPCC-uniform-nopaired/monitor-${i}
        cp *partition*.log results/TPCC-uniform-nopaired/monitor-${i}/
        ./scripts/save_results.sh results/TPCC-uniform-nopaired/monitor-${i}
        sleep 5m
done
