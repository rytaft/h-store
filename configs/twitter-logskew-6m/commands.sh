...
ant hstore-prepare -Dproject=twitter -Dhosts="istc6:0:0-5;istc7:1:6-11;istc8:2:12-17;istc9:3:18-23;istc10:4:24-29"
...
ant hstore-benchmark -Dproject=twitter -Dglobal.hasher_plan=plan.json -Dglobal.hasher_class=edu.brown.hashing.TwoTieredRangeHasher -Dnostart=true -Dnoloader=true -Dnoshutdown=true -Dclient.duration=60000 -Dclient.interval=1000 -Dclient.txnrate=2000 -Dclient.count=4 -Dclient.hosts="istc4;istc13;istc11;istc12" -Dclient.threads_per_host=16 -Dclient.blocking_concurrent=30 -Dclient.output_results_csv=results.csv -Dclient.output_interval=true -Dsite.planner_caching=false -Dclient.txn_hints=false -Dsite.exec_early_prepare=false -Dclient.output_basepartitions=true -Dclient.memory=50240 | tee out.log
