...
//        testImpl(false, true, 5, 0, reactive, 59, config, 0.65);
        testImpl(false, true, 0.15, 0, reactive, 140, config, 0.05);
        testImpl(false, true, 0.15, 0, reactive, 47, config, 0.15);
        testImpl(false, true, 0.15, 0, reactive, 29, config, 0.25);
        testImpl(false, true, 0.15, 0, reactive, 21, config, 0.35);
        testImpl(false, true, 0.15, 0, reactive, 16, config, 0.45);
        testImpl(false, true, 0.15, 0, reactive, 13, config, 0.55);
        testImpl(false, true, 0.15, 0, reactive, 11, config, 0.65);
...
//        testImpl(true, false, 5, 0, simple1, 59, config, 0.65);
        testImpl(true, false, 0.15, 0, simple1, 140, config, 0.05);
        testImpl(true, false, 0.15, 0, simple1, 47, config, 0.15);
        testImpl(true, false, 0.15, 0, simple1, 29, config, 0.25);
        testImpl(true, false, 0.15, 0, simple1, 21, config, 0.35);
        testImpl(true, false, 0.15, 0, simple1, 16, config, 0.45);
        testImpl(true, false, 0.15, 0, simple1, 13, config, 0.55);
        testImpl(true, false, 0.15, 0, simple1, 11, config, 0.65);
...
//         testImpl(false, false, 5, 0, predRetrain1month, 59, config, 0.65);
         testImpl(false, false, 0.15, 0, predRetrain1month, 47, config, 0.15);
         testImpl(false, false, 0.15, 0, predRetrain1month, 29, config, 0.25);
         testImpl(false, false, 0.15, 0, predRetrain1month, 21, config, 0.35);
         testImpl(false, false, 0.15, 0, predRetrain1month, 16, config, 0.45);
         testImpl(false, false, 0.15, 0, predRetrain1month, 13, config, 0.55);
         testImpl(false, false, 0.15, 0, predRetrain1month, 11, config, 0.65);
...
//         testImpl(false, false, 5, 0, predOracle, 59, config, 0.65);
         testImpl(false, false, 0.15, 0, predOracle, 47, config, 0.15);
         testImpl(false, false, 0.15, 0, predOracle, 29, config, 0.25);
         testImpl(false, false, 0.15, 0, predOracle, 21, config, 0.35);
         testImpl(false, false, 0.15, 0, predOracle, 16, config, 0.45);
         testImpl(false, false, 0.15, 0, predOracle, 13, config, 0.55);
         testImpl(false, false, 0.15, 0, predOracle, 11, config, 0.65);
