...
public class TestPlannedPartitions extends BaseTestCase {
    ...
    public void testReadJSON() throws Exception {
        ...
        TwoTieredRangePartitions p = new TwoTieredRangePartitions(catalogContext, test_json1);
    ...
    public void testExtractTableNames() throws Exception {
        ...
        Set<String> tbls = TwoTieredRangePartitions.getExplicitPartitionedTables(test_json);
