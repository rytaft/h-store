...
public class TestMultiColumnPlannedPartitions extends BaseTestCase {

	private static final Logger LOG = Logger.getLogger(TestMultiColumnPlannedPartitions.class);
    private static boolean init = false;
	
    public TestMultiColumnPlannedPartitions() {
...
"    	}";
    ...
    protected void setUp() throws Exception {
        ...
        json_path = FileUtil.join(tmp_dir, "test.json");
        FileUtil.writeStringToFile(json_path, test_json);
    }

    public void testReadJSON() throws Exception {
        File f1 = new File(json_path.getAbsolutePath());
        assertNotNull(f1);
        assert (f1.exists());
    ...
    public void testExtractTableNames() throws Exception {
        JSONObject test_json_obj = new JSONObject(test_json);
        PlannedPartitions p = new PlannedPartitions(catalogContext, test_json_obj);
        Set<String> tbls = p.getExplicitPartitionedTables(test_json_obj);
