...
public class Example2Fitness implements FitnessEvaluationAlgorithm {

	public Example2Fitness() {}
	...
	public Fitness evaluateFitness(Individual individual, int age, Population population, GAParameterSet params) {
		...
		double p = indiv.getDoubleValue(0);
		double q = indiv.getDoubleValue(1);
		double f = -Math.abs(Math.PI - p / q);
