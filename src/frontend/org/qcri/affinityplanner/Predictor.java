...
public class Predictor {
    ...
    public ArrayList<Long> predictLoad (ConcurrentLinkedQueue<Long> currentLoad, int numPredsAhead, String modelCoefficientsFileName){
        ...
        if( currentLoad.size() < modelOrder ){
            ...
            ArrayList<Long> currentLoadCopy = new ArrayList<Long>(currentLoad.size());
            for (Long currentLoadElem : currentLoad){
                currentLoadCopy.add(currentLoadElem - (long) xMean);
                lastTotalLoad = currentLoadElem;
            }
