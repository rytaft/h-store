...
public class ReconfigurationStatic extends VoltSystemProcedure {
  ...
  public void initImpl() {
    executor.registerPlanFragment(SysProcFragmentId.PF_reconfigurationStaticDistribute, this);
    executor.registerPlanFragment(SysProcFragmentId.PF_reconfigurationStaticAggregate, this);
  }
  ...
  public DependencySet executePlanFragment(Long txn_id, Map<Integer, List<VoltTable>> dependencies, int fragmentId, ParameterSet params,
    ...
    case SysProcFragmentId.PF_reconfigurationStaticDistribute: {
      try {
      ...
      result = new DependencySet(SysProcFragmentId.PF_reconfigurationStaticDistribute, vt);
      break;
    }
    case SysProcFragmentId.PF_reconfigurationStaticAggregate: {
      ...
      List<VoltTable> siteResults = dependencies.get(SysProcFragmentId.PF_reconfigurationStaticDistribute);
      ...
      result = new DependencySet(SysProcFragmentId.PF_reconfigurationStaticAggregate, vt);
      break;
    }
    default:
  ...
  public VoltTable[] run(int coordinator, String partition_plan, String protocol) {
    ...
    LOG.info(String.format("RUN : Init static reconfiguration. %s",msg));
