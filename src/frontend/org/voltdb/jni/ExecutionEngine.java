...
//            long undoQuantumToken) throws EEException;
    ...
    */
    ...
    // Reconfiguration
    // ----------------------------------------------------------------------------
    public abstract int extractTable(int table_id, byte[] serialized_table,long txnId, long lastCommittedTxnId, long undoToken) throws EEException;
    
    protected native int nativeExtractTable(long pointer, int table_id);//, int table_id, byte[] serialized_table,long txnId, long lastCommittedTxnId, long undoToken);
}
