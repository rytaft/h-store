-- Tree indexes used to improve performance of reconfiguration
...
CREATE INDEX IDX_STK_INVENTORY_STOCK_TREE ON STK_INVENTORY_STOCK(partition_key, sku);
...
CREATE INDEX IDX_STK_INVENTORY_STOCK_QUANTITY_TREE ON STK_INVENTORY_STOCK_QUANTITY(partition_key, id);
...
CREATE INDEX IDX_STK_STOCK_TRANSACTION_TREE ON STK_STOCK_TRANSACTION(partition_key, transaction_id);
...
CREATE INDEX IDX_CART_TREE ON CART(partition_key, id);
...
CREATE INDEX IDX_CART_CUSTOMER_TREE ON CART_CUSTOMER(partition_key, cartId);
...
CREATE INDEX IDX_CART_LINES_TREE ON CART_LINES(partition_key, cartId);
...
CREATE INDEX IDX_CART_LINE_PRODUCTS_TREE ON CART_LINE_PRODUCTS(partition_key, cartId);
...
CREATE INDEX IDX_CART_LINE_PROMOTIONS_TREE ON CART_LINE_PROMOTIONS(partition_key, cartId);
...
CREATE INDEX IDX_CART_LINE_PRODUCT_WARRANTIES_TREE ON CART_LINE_PRODUCT_WARRANTIES(partition_key, cartId);
...
CREATE INDEX IDX_CART_LINE_PRODUCT_STORES_TREE ON CART_LINE_PRODUCT_STORES(partition_key, cartId);
...
CREATE INDEX IDX_CHECKOUT_TREE ON CHECKOUT(partition_key, id);
...
CREATE INDEX IDX_CHECKOUT_PAYMENTS_TREE ON CHECKOUT_PAYMENTS(partition_key, checkoutId);
...
CREATE INDEX IDX_CHECKOUT_FREIGHT_DELIVERY_TIME_TREE ON CHECKOUT_FREIGHT_DELIVERY_TIME(partition_key, checkoutId);
...
CREATE INDEX IDX_CHECKOUT_STOCK_TRANSACTIONS_TREE ON CHECKOUT_STOCK_TRANSACTIONS(partition_key, checkoutId);
