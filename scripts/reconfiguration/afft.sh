...
EXP_TYPES=( \
#    "affinity-ms --partitions=12 --benchmark-size=ss --exp-suffix=ss" \
    "affinity-test --partitions=8 --benchmark-size=ss --exp-suffix=test" \
#    "affinity-ms --partitions=12 --benchmark-size=l --exp-suffix=l" \
