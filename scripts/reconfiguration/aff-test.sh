...
EXP_TYPES=( \
    ...
    "affinity-dyn --partitions=4 --benchmark-size=s --exp-suffix=s" \
    "affinity-dyn --partitions=4 --benchmark-size=m --exp-suffix=m" \
    "affinity-dyn --partitions=4 --benchmark-size=l --exp-suffix=l" \
